...
def write_file_open(out: TextIOWrapper) :
    out.write("#ifndef COMMON_INSTR_OPCODE_GEN_HPP\n")
    out.write("#define COMMON_INSTR_OPCODE_GEN_HPP\n\n")
...
def write_enum_open(out: TextIOWrapper) :
    out.write("enum class InstrOpcode : uint8_t {\n")
...
def write_file_close(out: TextIOWrapper) :
    ...
    out.write("#endif // COMMON_INSTR_OPCODE_GEN_HPP\n\n")
...
if __name__ == "__main__" :
    ...
    for name, instr in instrs.items() :
        write_enum_value(out, name, instr["opcode"])
